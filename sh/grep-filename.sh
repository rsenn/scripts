...
grep_filename() {
  BS="\\"
  FS="/"
  archives_EXTS="rar zip 7z cab cpio cpio.Z cpio.gz cpio.xz cpio.bz2 cpio.lzma tar tar.Z tar.gz tar.xz tar.lzma tar.bz2 tar.lzma tar.zst tgz txz tbz2 tlzma cpio"
