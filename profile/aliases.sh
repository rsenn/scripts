...
alias prettier='prettier --trailing-comma none --write  --print-width 200 --semi --bracket-spacing'
alias prettier-eslint='prettier-eslint --trailing-comma none --write  --print-width 200 --semi --bracket-spacing'
